...
func (c *metricsServiceClient) GetMetrics(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*MetricsResponse, error) {
...
func (UnimplementedMetricsServiceServer) GetMetrics(context.Context, *emptypb.Empty) (*MetricsResponse, error) {
